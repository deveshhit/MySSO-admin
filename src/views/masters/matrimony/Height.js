...
const Height = () => {
    ...
    const [addheighttype, setHeighttype] = useState('');



    useEffect(() => {
        getHeightList(page, perPage)
    }, [])

    const getHeightList = async (page, perPage) => {
        try {
            const requestOption = {
                method: "GET",
                headers: {
            ...
            await fetch(`${API_URL}/api/heightList?page=${page}&limit=${perPage}`, requestOption)
    ...
    const handlePageClick = (e) => {
        ...
        getHeightList(selectedPage, perPage);
    };
    ...
    const getdetails = async (id) => {
        try {
            ...
            await fetch(`${API_URL}/api/getHeightdetailsbyid?id=${id}`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const addusertypedata = async (e) => {
        e.preventDefault();
        console.log("addusertype>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", addheighttype)
        try {
            ...
            const requestOption = {
                ...
                body: JSON.stringify({ type: addheighttype }),
            }
            await fetch(`${API_URL}/api/addHeight`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        swal(data.message, {
    ...
    const updateusertype = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/heightUpdate`, {
                method: 'put',
    ...
    const updatestatus = (id, status) => {
        try {
            ...
            fetch(`${API_URL}/api/heightUpdate`, requestOption)
                .then(response => response.json())
                .then(data => {
                    console.log(data)
                    if (data.status === 200) {
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <form action="/" method="POST">
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <label className="form-label"><strong>Height Type</strong></label>
                                                    <input type='text' className="form-control"
                                                        name='usertype'
