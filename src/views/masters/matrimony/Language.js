...
const Language = () => {
    ...
    useEffect(() => {
        getLanguageList(page, perPage)
    }, [])

    const getLanguageList = async (page, perPage) => {
        try {
            setIsloading(true)
            const requestOption = {
                method: "GET",
            ...
            await fetch(`${API_URL}/api/languageList?page=${page}&limit=${perPage}`, requestOption)
    ...
    const handlePageClick = (e) => {
        ...
        getLanguageList(selectedPage, perPage);
    };
    ...
    const getdetails = async (id) => {
        try {
            ...
            await fetch(`${API_URL}/api/getLanguageDetailsById?id=${id}`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        setType(data.data.language)
                    } else {
                        console.log(data.message)
                    }
                })
    ...
    const addusertypedata = async (e) => {
        e.preventDefault();
        console.log("addusertype>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", languagetype)
        try {
            ...
            const requestOption = {
                ...
                body: JSON.stringify({ language: languagetype }),
            }
            await fetch(`${API_URL}/api/addLanguage`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        swal(data.message, {
    ...
    const updateusertype = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/updateLanguage`, {
                method: 'put',
                body: JSON.stringify({ id: id, language: type }),
                headers: {
                    'Content-Type': 'application/json',
                },
            })
    ...
    const updatestatus = (id, status) => {
        try {
            ...
            fetch(`${API_URL}/api/updateLanguage`, requestOption)
                .then(response => response.json())
                .then(data => {
                    console.log(data)
                    if (data.status === 200) {
