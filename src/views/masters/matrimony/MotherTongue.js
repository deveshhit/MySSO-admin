...
const MotherTongue = () => {
    ...
    const [addmothertonguetype, setMothertonguetype] = useState('');
    ...
    useEffect(() => {
        getMotherTongueList(page, perPage)
    }, [])

    const getMotherTongueList = async (page, perPage) => {
        try {
            setIsloading(true)
            const requestOption = {
                method: "GET",
            ...
            await fetch(`${API_URL}/api/motherTongueList?page=${page}&limit=${perPage}`, requestOption)
    ...
    const handlePageClick = (e) => {
        ...
        getMotherTongueList(selectedPage, perPage);
    };
    ...
    const getdetails = async (id) => {
        try {
            ...
            await fetch(`${API_URL}/api/getMotherTongueDetailsById?id=${id}`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const addusertypedata = async (e) => {
        e.preventDefault();
        console.log("addusertype>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", addmothertonguetype)
        try {

            if (!addmothertonguetype) {
            ...
            const requestOption = {
                ...
                body: JSON.stringify({ type: addmothertonguetype }),
            }
            await fetch(`${API_URL}/api/addMotherTongue`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        swal(data.message, {
    ...
    const updateusertype = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/motherTongueUpdate`, {
                method: 'put',
    ...
    const updatestatus = (id, status) => {
        try {
            ...
            fetch(`${API_URL}/api/motherTongueUpdate`, requestOption)
                .then(response => response.json())
                .then(data => {
                    console.log(data)
                    if (data.status === 200) {
                                ...
                                <div className="card-header">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <h4 className="card-title">Mother tongue</h4>
                                        </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    ...
                                                    <input type='text' className="form-control"
                                                        ...
                                                        required
                                                        autoComplete="off"
                                                        onChange={(e) => setMothertonguetype(e.target.value)}
                                                    />
                                                </div>
                                            </div>
                                            <div className="row">
