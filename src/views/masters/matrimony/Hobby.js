...
const Hobby = () => {
    ...
    const [addhobbytype, setHobbytype] = useState('');



    useEffect(() => {
        getHobbyList(page, perPage)
    }, [])

    const getHobbyList = async (page, perPage) => {
        try {
            const requestOption = {
                method: "GET",
                headers: {
            ...
            await fetch(`${API_URL}/api/hobbyList?page=${page}&limit=${perPage}`, requestOption)
    ...
    const handlePageClick = (e) => {
        ...
        getHobbyList(selectedPage, perPage);
    };
    ...
    const getdetails = async (id) => {
        try {
            ...
            await fetch(`${API_URL}/api/getHobbydetailsbyid?id=${id}`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const addusertypedata = async (e) => {
        e.preventDefault();
        console.log("addusertype>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", addhobbytype)
        try {
            ...
            const requestOption = {
                ...
                body: JSON.stringify({ type: addhobbytype }),
            }
            await fetch(`${API_URL}/api/addHobby`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        swal(data.message, {
    ...
    const updateusertype = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/hobbyUpdate`, {
                method: 'put',
    ...
    const updatestatus = (id, status) => {
        try {
            ...
            fetch(`${API_URL}/api/hobbyUpdate`, requestOption)
                .then(response => response.json())
                .then(data => {
                    console.log(data)
                    if (data.status === 200) {
                                ...
                                <div className="card-header">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <h4 className="card-title">Hobby List</h4>
                                        </div>
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <form action="/" method="POST">
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <label className="form-label"><strong>Hobby Type</strong></label>
                                                    <input type='text' className="form-control"
                                                        name='usertype'
