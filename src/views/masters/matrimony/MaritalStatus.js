...
const MaritalStatus = () => {
    ...
    const [addmaritalstatustype, setMaritalstatustype] = useState('');
    ...
    const getMaritalstatusList = async (page, perPage) => {
        try {
            setIsloading(true)
            const requestOption = {
                method: "GET",
            ...
            await fetch(`${API_URL}/api/maritalStatusList?page=${page}&limit=${perPage}`, requestOption)
    ...
    const handlePageClick = (e) => {
        ...
        getMaritalstatusList(selectedPage, perPage);
    };
    ...
    const getdetails = async (id) => {
        try {
            ...
            await fetch(`${API_URL}/api/getMaritalStatusdetailsbyid?id=${id}`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const addusertypedata = async (e) => {
        e.preventDefault();
        console.log("addusertype>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", addmaritalstatustype)
        try {

            if (!addmaritalstatustype) {
            ...
            const requestOption = {
                ...
                body: JSON.stringify({ type: addmaritalstatustype }),
            }
            await fetch(`${API_URL}/api/addMaritalStatus`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        swal(data.message, {
    ...
    const updateusertype = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/maritalStatusUpdate`, {
                method: 'put',
    ...
    const updatestatus = (id, status) => {
        try {
            ...
            fetch(`${API_URL}/api/maritalStatusUpdate`, requestOption)
                .then(response => response.json())
                .then(data => {
                    console.log(data)
                    if (data.status === 200) {
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    ...
                                                    <input type='text' className="form-control"
                                                        ...
                                                        required
                                                        autoComplete="off"
                                                        onChange={(e) => setMaritalstatustype(e.target.value)}
                                                    />
                                                </div>
                                            </div>
                                            <div className="row">
