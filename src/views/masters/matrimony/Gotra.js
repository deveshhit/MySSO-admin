...
const Gotra = () => {
    ...
    const [addgotratype, setGotratype] = useState('');



    useEffect(() => {
        getGotraList(page, perPage)
    }, [])

    const getGotraList = async (page, perPage) => {
        try {
            const requestOption = {
                method: "GET",
                headers: {
            ...
            await fetch(`${API_URL}/api/gotraList?page=${page}&limit=${perPage}`, requestOption)
    ...
    const handlePageClick = (e) => {
        ...
        getGotraList(selectedPage, perPage);
    };
    ...
    const getdetails = async (id) => {
        try {
            ...
            await fetch(`${API_URL}/api/getGotradetailsbyid?id=${id}`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const addusertypedata = async (e) => {
        e.preventDefault();
        console.log("addusertype>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", addgotratype)
        try {
            ...
            const requestOption = {
                ...
                body: JSON.stringify({ type: addgotratype }),
            }
            await fetch(`${API_URL}/api/addGotra`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        swal(data.message, {
    ...
    const updateusertype = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/gotraUpdate`, {
                method: 'put',
    ...
    const updatestatus = (id, status) => {
        try {
            ...
            fetch(`${API_URL}/api/gotraUpdate`, requestOption)
                .then(response => response.json())
                .then(data => {
                    console.log(data)
                    if (data.status === 200) {
                                ...
                                <div className="card-header">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <h4 className="card-title">Gotra List</h4>
                                        </div>
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <form action="/" method="POST">
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <label className="form-label"><strong>Gotra Type</strong></label>
                                                    <input type='text' className="form-control"
                                                        name='usertype'
