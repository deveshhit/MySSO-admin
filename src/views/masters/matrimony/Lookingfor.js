...
const Lookingfor = () => {
    ...
    const [addlookingfortype, setAddlookingfortype] = useState('');
    const [isloading, setIsloading] = useState(false);



    useEffect(() => {
        getLookingforList(page, perPage)
    }, [])

    const getLookingforList = async (page, perPage) => {
        try {
            setIsloading(true)
            const requestOption = {
                method: "GET",
            ...
            await fetch(`${API_URL}/api/usergendertypeList?page=${page}&limit=${perPage}`, requestOption)
    ...
    const handlePageClick = (e) => {
        ...
        getLookingforList(selectedPage, perPage);
    };
    ...
    const getdetails = async (id) => {
        try {
            ...
            await fetch(`${API_URL}/api/getUsergendertypedetailsbyid?id=${id}`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const addusertypedata = async (e) => {
        e.preventDefault();
        console.log("addusertype>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>", addlookingfortype)
        try {

            if (!addlookingfortype) {
            ...
            const requestOption = {
                ...
                body: JSON.stringify({ type: addlookingfortype }),
            }
            await fetch(`${API_URL}/api/usergendertype`, requestOption)
                .then((response) => response.json())
                .then((data) => {
                    if (data.status == 200) {
                        swal(data.message, {
    ...
    const updateusertype = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/api/usergendertypeUpdate`, {
                method: 'put',
    ...
    const updatestatus = (id, status) => {
        try {
            ...
            fetch(`${API_URL}/api/usergendertypeUpdate`, requestOption)
                .then(response => response.json())
                .then(data => {
                    console.log(data)
                    if (data.status === 200) {
                                ...
                                <div className="card-header">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <h4 className="card-title">Looking For List</h4>
                                        </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    ...
                                                    <input type='text' className="form-control"
                                                        ...
                                                        required
                                                        autoComplete="off"
                                                        onChange={(e) => setAddlookingfortype(e.target.value)}
                                                    />
                                                </div>
                                            </div>
                                            <div className="row">
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <form action="/" method="POST">
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <label className="form-label"><strong>Role Type</strong></label>
                                                    <input type='text' className="form-control"
                                                        name='usertype'
